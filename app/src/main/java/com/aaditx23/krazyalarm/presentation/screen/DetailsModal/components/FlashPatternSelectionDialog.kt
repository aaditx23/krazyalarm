...
@Composable
fun FlashPatternSelectionDialog(
    selectedPattern: FlashPattern,
    onPatternSelected: (FlashPattern) -> Unit,
    onDismiss: () -> Unit
) {
...
@Composable
private fun PatternSelectionItem(
    patternName: String,
    isSelected: Boolean,
    onClick: () -> Unit
) {
